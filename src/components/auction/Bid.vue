<template>
    <div class="black-bg" v-if="호가정책 == true" style="">
        <div class="white-bg">
            <div class="header-container">
                <h4>경매 호가표</h4>
                <button type="button" class="btn-close top" aria-label="Close" @click="호가정책 = false"></button>
            </div>
            <table class="table">
    ...
    <div class="black-bg" v-if="낙찰수수료 == true">
        <div class="white-bg">
            <div class="header-container">
                <h4>낙찰 수수료</h4>
                <button type="button" class="btn-close top" aria-label="Close" @click="낙찰수수료 = false"></button>
            </div>
            <table class="table">
                <thead class="table-light">
                    <tr>
    ...
    <div class="black-bg" v-if="입찰하기 == true">
        <div class="white-bg header-container">
            <button type="button" class="btn-close" aria-label="Close" @click="입찰하기 = false"></button>
            <div class="pwWrap">
                <div class="pwSection">
                    <span class="dot"></span>
                    <span class="dot"></span>
        ...
        <div class="split-screen">
            ...
            <div class="right">
                ...
                <div class="d-grid gap-4 d-md-flex justify-content-md-end bid-btn">
                    ...
                    <button class="btn btn-secondary w-25" type="button"><i
                            class="bi bi-bookmark-heart-fill"></i></button>
                </div>

                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-outline-secondary me-md-2" type="button" @click="호가정책 = true">
                        호가 정책
                    </button>
                    <button class="btn btn-outline-secondary" type="button" @click="낙찰수수료 = true">
                        수수료 정책
                    </button>
                </div>
            </div>
